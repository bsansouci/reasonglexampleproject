...
module Make (Gl: Gl.t) => {
  ...
  let getProgram
    ...
    if compiledCorrectly {
      ...
      if compiledCorrectly {
        ...
        Gl.attachShader context::gl program::program shader::vertexShader;
        Gl.deleteShader context::gl shader::vertexShader;
        Gl.attachShader context::gl program::program shader::fragmentShader;
        Gl.deleteShader context::gl shader::fragmentShader;
        Gl.linkProgram gl program;
        let linkedCorrectly =
          Gl.getProgramParameter context::gl program::program paramName::Gl.Link_status == 1;
        if linkedCorrectly {
          Some program
        } else {
          print_endline @@ "Linking error: " ^ Gl.getProgramInfoLog context::gl program::program;
          None
        }
      } else {
        print_endline @@
  ...
  let program =
    switch (
      getProgram gl::gl vertexShader::vertexShaderSource fragmentShader::fragmentShaderSource
    ) {
  ...
  let aVertexPosition = Gl.getAttribLocation context::gl program::program name::"aVertexPosition";
  Gl.enableVertexAttribArray context::gl attribute::aVertexPosition;
  let aVertexColor = Gl.getAttribLocation context::gl program::program name::"aVertexColor";
